...
void card_adventurer(struct gameState *state, int currentPlayer){
	...
	while(drawntreasure < 2){
		...
		if (cardDrawn == copper || cardDrawn == silver || cardDrawn == gold) { drawntreasure++; }
			...
			state->handCount[currentPlayer]--; // This should remove the top card/most recently drawn
			z++;
		}
	}
	while( z >= 0 ){
...
void card_cutpurse(struct gameState *state, int currentPlayer, int handPos){
	int i, j, k;
...
void card_sea_hag(struct gameState *state, int currentPlayer){
	int i;
...
void card_minion(struct gameState *state, int currentPlayer, int handPos, int choice1, int choice2){
	int i, j;
...
//  int z = 0;// this is the counter for the temp hand
  ...
  switch( card ) 
    ...
    case smithy:
	card_smithy(state, currentPlayer, handPos);
      return 0;
    ...
    case minion:
	card_minion(state, currentPlayer, handPos, choice1, choice2);
	return 0;
    ...
    case cutpurse:
	card_cutpurse(state, currentPlayer, handPos);
	return 0;
    ...
    case sea_hag:
	card_sea_hag(state, currentPlayer);
	return 0;
